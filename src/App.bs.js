  ...
  return /* record */[
          ...
          /* render */(function (self) {
              var handleItemClick = function (searchItem) {
                SpotifyAPI$ReactTemplate.Request[/* getAlbumHack */12](searchItem[/* id */1]).then((function (trackIds) {
                          return Promise.all(/* tuple */[
                                      SpotifyAPI$ReactTemplate.Request[/* getTracksHack */13](trackIds),
                                      SpotifyAPI$ReactTemplate.Request[/* getAudioFeaturesHack */14](trackIds)
                                    ]);
                        })).then((function (param) {
              ...
              return React.createElement("div", undefined, ReasonReact.element(undefined, undefined, Picker$ReactTemplate.make(handleItemClick, (function (param) {
                                  ...
                                  }), /* array */[])), self[/* state */1].length !== 0 ? ReasonReact.element(undefined, undefined, Songs$ReactTemplate.make(self[/* state */1], /* array */[])) : null);
            }),
          ...
          /* reducer */(function (param, _state) {
              return /* Update */Block.__(0, [param[0]]);
            }),
